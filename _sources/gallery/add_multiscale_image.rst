...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/runner/work/napari-docs/napari-docs/main/examples/add_multiscale_image.py:17: FutureWarning: `multichannel` is a deprecated argument name for `pyramid_gaussian`. It will be removed in version 1.0. Please use `channel_axis` instead.
